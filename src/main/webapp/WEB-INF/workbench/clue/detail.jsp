...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" onclick="window.location.href='/crm/workbench/clue/queryById?id=${clue.id}';"><span class="glyphicon glyphicon-retweet"></span> 转换</button>
	...
	<div style="position: relative; top: -70px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 60px;">
			...
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${clue.editBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">2017-01-19 10:10:10</small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
					...
					<tbody id="bindBody">
                     <c:forEach items="${clue.activities}" var="activity">
                         <tr>
                             ...
                             <td><a href="javascript:void(0);" onclick="unbind('${clue.id}','${activity.id}',$(this))" style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>
                         </tr>
                     </c:forEach>
...
<script>
    ...
    //点击关联市场活动按钮，弹出模态窗，触发回车事件
    $('#activityName').keydown(function (event) {
        //触发回车事件
        if(event.keyCode == 13){
            $.get("/crm/workbench/clue/queryActivityByName",{
                'id' : '${clue.id}',
                'name' : $(this).val()
            },function(data){
                var content = "";
