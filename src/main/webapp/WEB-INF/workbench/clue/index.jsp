	...
	<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="height: 80px;">
				<form id="clueForm" class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <div class="form-group">
				    <div class="input-group">
					  ...
					  <select class="form-control" name="state">
                          ...
                          <%--遍历字典类型--%>
                          <c:forEach items="${dictionaryTypes}" var="dictionaryType">
                              <c:if test="${dictionaryType.code eq 'clueState'}">
                                  <%--遍历线索来源类型对应的值--%>
                                  <c:forEach items="${dictionaryType.dictionaryValues}" var="dictionaryValue">
                                      <option value="${dictionaryValue.value}">${dictionaryValue.text}</option>
                                  </c:forEach>
...
<script>
    ...
    function refresh(page,pageSize){
        $.post("/crm/clue/clueList",$('#clueForm').serialize(),function(data){
            var content = "";
            for(var i = 0; i <data.dataList.length;i++){
                var clue = data.dataList[i];
                content += "<tr>\n" +
                    "\t\t\t\t\t\t\t<td><input type=\"checkbox\" /></td>\n" +
                    "\t\t\t\t\t\t\t<td><a style=\"text-decoration: none; cursor: pointer;\" href='/crm/workbench/clue/clueDetail?id="+clue.id+"'>"+clue.fullname+""+clue.appellation+"</a></td>\n" +
                    "\t\t\t\t\t\t\t<td>"+clue.company+"</td>\n" +
                    "\t\t\t\t\t\t\t<td>"+clue.phone+"</td>\n" +
                    "\t\t\t\t\t\t\t<td>"+clue.mphone+"</td>\n" +
                    "\t\t\t\t\t\t\t<td>"+clue.source+"</td>\n" +
